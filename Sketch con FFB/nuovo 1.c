...
#define DEVICE_UNIQUE_ID "851eaa22-4118-49bf-ba32-577e46dbd502" //{"UniqueId":"851eaa22-4118-49bf-ba32-577e46dbd502","Name":"DEVICE_UNIQUE_ID","Type":"uniqueid"}
...
// https://github.com/zegreatclan/SimHub/wiki/Arduino-Shake-It
// --------------------------------------------------------------------------------------------------------
#define SHAKEITPWM_ENABLED_MOTORS 1 //{"Group":"SHAKEIT PWM Outputs","Name":"SHAKEITPWM_ENABLED_MOTORS","Title":"ShakeIT direct PWM outputs enabled, for fans, TIP120 or any PWM driven custom boards","DefaultValue":"0","Type":"int","Max":4}
#ifdef INCLUDE_SHAKEITPWM
#define SHAKEITPWM_O1 10            //{"Name":"SHAKEITPWM_O1","Title":"PWM Output 1 pin","DefaultValue":"5","Type":"pin;ShakeIt PWM 1","Condition":"SHAKEITPWM_ENABLED_MOTORS>=1"}
...
void loop() {
	...
	analog2map = map(analog2, 0, 1023, 0, 4096);
	analog2map = map(analog2, 0, 1023, 10240, 32768);
